defmodule CursoElixirDbWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: CursoElixirDbWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/curso_elixir_db_web/templates",
  ...
  defp view_helpers do
    quote do
      ...
      import CursoElixirDbWeb.ErrorHelpers
      import CursoElixirDbWeb.Gettext
      alias CursoElixirDbWeb.Router.Helpers, as: Routes
    end
  end
